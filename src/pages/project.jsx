...
function project() {
    ...
    return (
        ...
        <div className="md:mt-[10%] mt-[20%]">
            ...
            <div className="flex md:flex-row flex-col justify-center items-center gap-6 mt-[10%] ">
                {projectGH.map((project, index) => (
                    <div key={index} className="bg-white shadow-lg rounded-xl p-8 hover:shadow-2xl transition md:w-[25%] w-[65%]  hover:brightness-75 ">
